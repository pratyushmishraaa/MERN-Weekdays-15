...
userRouter.put("/updateprofile", verificationToken, updateProfileLimiter, upload.single("avatar"), updateUser);
userRouter.put("/changepassword", verificationToken, changePassword);
